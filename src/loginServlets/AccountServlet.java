...
//		if(rand == null){
//			request.getSession().getServletContext().setAttribute("rand", new Random());
//			rand = (Random)request.getSession().getServletContext().getAttribute("rand");
//		}
...
//        					+ "ErrorPassword.jsp?title=Account Create Error&message=You Must Have a Password!");
